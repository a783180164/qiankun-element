/*
 * @Author: your name
 * @Date: 2021-04-26 10:23:23
 * @LastEditTime: 2021-04-26 11:05:20
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \qiankun-element\master\src\common\js\utils.js
 */
/**
 * 严肃声明：
...
interface Tdist {
  ...
  getLev1?(): Array<TArray>
  getLev2?(t: string ): Array<TArray>
  getLev3?(t: string ): Array<TArray>
}
export const tdist: Tdist = {
  210184: ["沈北新区", "210100"],
  210185: ["其它区", "210100"],
  420381: ["丹江口市", "420300"],
  420383: ["其它区", "420300"],
...
tdist.getLev2 = function(t) {
  ...
  const e = []
  for (let i = 1; i < 100; i++) {
    let n: string = t.substr(0, 2);
    n += i < 10 ? "0" + i + "00" : i + "00";
    const r = this[parseInt(n)];
    "undefined" != typeof r &&
      e.push({
        id: n,
        text: r[0]
